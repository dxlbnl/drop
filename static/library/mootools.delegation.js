(function() {
	...
	Element.implement({
		...
		'hoistEvent': function(parent, type, fn, prevent, propagate)
		{
			var delegates = {};
			delegates[this.toSelector()] = fn;
			return parent.delegateEvent.apply(parent, [type, delegates, prevent, propagate]);
		},
		'hoistEvents': function(parent, types, prevent, propagate)
		{
			var delegates = {},
			...
			return parent.delegateEvents.apply(parent, [delegates, prevent, propagate]);
		},
